...
1.  **Cadastro:** Requer apenas `email` e `password`. A senha passa por processo de hashing antes da persistência no PostgreSQL.
2.  **Login e Refresh de Identidade:**
...
3.  **Middleware de Proteção:** Intercepta rotas privadas, valida a assinatura do segredo JWT e verifica a integridade da sessão.

## 🗄️ 5. Resumo do Esquema de Dados (Prisma)
*   **User:** Armazena credenciais e metadados da conta real.
